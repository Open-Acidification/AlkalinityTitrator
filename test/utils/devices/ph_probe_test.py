...
from titration.utils.devices import ads_mock
from titration.utils.devices.ph_probe import PHProbe
...
def test_ph_create():
    ...
    assert ph_test.channel.p0 == ads_mock.P0
    assert ph_test.channel.p1 == ads_mock.P1
